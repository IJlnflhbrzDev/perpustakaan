...
if ($_GET['aksi'] == "pinjam") {
    ...
    if ($_POST['kondisiBukuSaatDikembalikan'] == "0 Hari") {
        $denda = "Tidak ada";
    } elseif ($_POST['kondisiBukuSaatDikembalikan'] == "Terlambat 1 Hari") {
        $denda = "Rp 20.000";
    } elseif ($_POST['kondisiBukuSaatDikembalikan'] == "Terlambat 2 Hari") {
        $denda = "Rp 30.000";
    } elseif ($_POST['kondisiBukuSaatDikembalikan'] == "Terlambat 3 Hari") {
        $denda = "Rp 35.000";
    } elseif ($_POST['kondisiBukuSaatDikembalikan'] == "Terlambat 4 Hari") {
        $denda = "Rp 40.000";
